  ...
  internal func handleMethod(
    ...
    case "CurrentPlan":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.currentPlan(request: request, context: context)
        }
      }
    ...
    case "AppliedPlan":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.appliedPlan(request: request, context: context)
        }
      }
    ...
    case "UpgradedConsensusState":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.upgradedConsensusState(request: request, context: context)
        }
      }
