  ...
  internal func handleMethod(
    ...
    case "CreateClient":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.createClient(request: request, context: context)
        }
      }
    ...
    case "UpdateClient":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.updateClient(request: request, context: context)
        }
      }
    ...
    case "UpgradeClient":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.upgradeClient(request: request, context: context)
        }
      }
    ...
    case "SubmitMisbehaviour":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.submitMisbehaviour(request: request, context: context)
        }
      }
