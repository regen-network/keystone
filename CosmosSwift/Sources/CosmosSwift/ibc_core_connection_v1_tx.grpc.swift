  ...
  internal func handleMethod(
    ...
    case "ConnectionOpenInit":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionOpenInit(request: request, context: context)
        }
      }
    ...
    case "ConnectionOpenTry":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionOpenTry(request: request, context: context)
        }
      }
    ...
    case "ConnectionOpenAck":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionOpenAck(request: request, context: context)
        }
      }
    ...
    case "ConnectionOpenConfirm":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionOpenConfirm(request: request, context: context)
        }
      }
