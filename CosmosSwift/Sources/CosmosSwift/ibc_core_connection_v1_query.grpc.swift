  ...
  internal func handleMethod(
    ...
    case "Connection":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connection(request: request, context: context)
        }
      }
    ...
    case "Connections":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connections(request: request, context: context)
        }
      }
    ...
    case "ClientConnections":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.clientConnections(request: request, context: context)
        }
      }
    ...
    case "ConnectionClientState":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionClientState(request: request, context: context)
        }
      }
    ...
    case "ConnectionConsensusState":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionConsensusState(request: request, context: context)
        }
      }
