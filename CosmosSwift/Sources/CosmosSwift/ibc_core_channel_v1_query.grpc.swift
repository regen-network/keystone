  ...
  internal func handleMethod(
    ...
    case "Channel":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.channel(request: request, context: context)
        }
      }
    ...
    case "Channels":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.channels(request: request, context: context)
        }
      }
    ...
    case "ConnectionChannels":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.connectionChannels(request: request, context: context)
        }
      }
    ...
    case "ChannelClientState":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.channelClientState(request: request, context: context)
        }
      }
    ...
    case "ChannelConsensusState":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.channelConsensusState(request: request, context: context)
        }
      }
    ...
    case "PacketCommitment":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.packetCommitment(request: request, context: context)
        }
      }
    ...
    case "PacketCommitments":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.packetCommitments(request: request, context: context)
        }
      }
    ...
    case "PacketReceipt":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.packetReceipt(request: request, context: context)
        }
      }
    ...
    case "PacketAcknowledgement":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.packetAcknowledgement(request: request, context: context)
        }
      }
    ...
    case "PacketAcknowledgements":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.packetAcknowledgements(request: request, context: context)
        }
      }
    ...
    case "UnreceivedPackets":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.unreceivedPackets(request: request, context: context)
        }
      }
    ...
    case "UnreceivedAcks":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.unreceivedAcks(request: request, context: context)
        }
      }
    ...
    case "NextSequenceReceive":
      return CallHandlerFactory.makeUnary(
        ...
        return { request in
          self.nextSequenceReceive(request: request, context: context)
        }
      }
